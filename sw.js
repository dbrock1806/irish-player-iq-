const CACHE='irish-iq-full-v3';
const ASSETS=['./','./index.html','./styles.css','./app.js','./roster.json','./schedule.json','./history.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
